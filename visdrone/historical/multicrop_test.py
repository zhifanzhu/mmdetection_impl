...
"""
    Given an original image, this script run detector on generated 10-crop patches,
    since cropping is done on the fly(without multiprocess, workers &c), can be slow.
    thus not used anymore.
"""
