# This is as compare with ssd512_r50_fromlayer2

# model settings
input_size = 512
model = dict(
    type='SingleStageDetector',
    pretrained='zoo/resnet50-19c8e357.pth',
    backbone=dict(
        type='SSDResNet',
        depth=50,
        num_stages=3,
        out_from=('layer2', '', '', '', '', '', ''),
        out_channels=(-1, 1024, 512, 256, 256, 256, 256),
        use_dilation_conv4=False,
        use_dilation_conv5=False,  # C5 will not be in backbone
...
log_level = 'INFO'
work_dir = './work_dirs/ssd512_r50_removeC5'
load_from = None
resume_from = None
workflow = [('train', 1)]
