...
data_root = '/home/damon/volatile/VisDrone2019-DET/'
...
data = dict(
    ...
    test=dict(
        ...
        resize_keep_ratio=False))
# optimizer
optimizer = dict(type='SGD', lr=1e-4, momentum=0.9, weight_decay=5e-4)  # Set lr properly for single GPU
...
# yapf:disable
log_config = dict(
    interval=1,  # log_step_count_steps
    hooks=[
