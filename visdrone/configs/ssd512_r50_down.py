''' Move down one layer and remove Conv5 '''
...
model = dict(
    ...
    backbone=dict(
        ...
        depth=50,
        num_stages=2,
        out_from=('layer2', 'layer3', '', '', '', '', ''),
        out_channels=(-1, -1, 512, 512, 256, 256, 128),
    ...
    bbox_head=dict(
        ...
        in_channels=(512, 1024, 512, 512, 256, 256, 128),
        num_classes=11,
        anchor_strides=(8, 8, 16, 32, 64, 128, 256),
...
log_level = 'INFO'
work_dir = './work_dirs/ssd512_r50_atrous_down'
load_from = None
resume_from = None
