...
detval_root = 'data/VisDrone2019-DET/VisDrone2018-DET-val/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=[data_root + 'VisDrone2018-VID-train/annotations_train.json',
                    detval_root + 'annotations_val.json'],
        ...
        extra_aug=dict(
            photo_metric_distortion=dict(
                ...
                hue_delta=18),
            random_patch=dict(patch_size=(896, ), overlap_thresh=0.5),
            random_uniform_patch=dict(patch_sizes=(896, ), overlap_thresh=0.5),
            random_crop=dict(
