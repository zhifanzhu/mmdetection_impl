...
model = dict(
    ...
    backbone=dict(
        ...
        depth=50,
        num_stages=2,
        out_from=('layer3', '', '', '', '', '', ''),  # not layer2 since atrousC4
        out_channels=(-1, 512, 512, 256, 256, 256, 256),
    ...
    bbox_head=dict(
        ...
        in_channels=(1024, 512, 512, 256, 256, 256, 256),
        num_classes=11,
...
log_level = 'INFO'
work_dir = './work_dirs/ssd512_r50_atrousC4_removeC5'
load_from = None
resume_from = None
workflow = [('train', 1)]
