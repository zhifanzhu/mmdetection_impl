...
twin['pair_module']=dict(
    type='PairSharedNonLocal',
    conv_final=True)

model = copy.deepcopy(common)
model['type'] = 'TwinTriSingleStageDetector'
model['twin'] = twin
model['twin_load_from'] = './workpairs/retinaMV2_nl_share_flip/epoch_12.pth'
model['middle'] = 'B'
...
test_cfg = dict(
    ...
    max_per_img=100)
# dataset settings
vid_dataset_type = 'TwinTriVIDDataset'
det_dataset_type = 'TwinTriDET30Dataset'
...
log_level = 'INFO'
work_dir = './workpairs/retinaMV2_256_twintri_B_NLf_share'
load_from = None
resume_from = None
workflow = [('train', 1)]
